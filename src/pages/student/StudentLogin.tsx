...
const StudentLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-student-primary/20 to-student-light/20 flex items-center justify-center p-4">
      <Card className="w-full max-w-md p-8 shadow-xl">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Student Login</h1>
          <p className="text-muted-foreground">Access your counseling portal</p>
          {bypassAuth && (
        ...
        <div className="space-y-4">
          ...
          <div className="text-center space-y-2">
            <Button variant="ghost" asChild>
              <a href="/student/register">Create Student Account</a>
            </Button>
            <Button variant="ghost" asChild>
